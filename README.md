...
The RewardBench finding is filed as a public issue on the benchmark's own tracker:
**[allenai/reward-bench#267](https://github.com/allenai/reward-bench/issues/267)**. It is
fully reproducible — [`reproduce/reproduce_rewardbench_length.py`](reproduce/reproduce_rewardbench_length.py)
